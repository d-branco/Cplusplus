...
bool  bsp(Point const a, Point const b, Point const c, Point const point)
{
	...
	if ((distance_to_line(a, b, c) == 0) || (distance_to_line(a, b, point) == 0)
		|| (distance_to_line(b, c, a) == 0)
		|| (distance_to_line(b, c, point) == 0)
		|| (distance_to_line(c, a, b) == 0)
		|| (distance_to_line(c, a, point) == 0))
		return (false);
...
Fixed line_side(Point l_start, Point l_end, Point point)
{
	if (((l_end.get_x() - l_start.get_x()) * (point.get_y() - l_start.get_y())
		 - (l_end.get_y() - l_start.get_y())
			   * (point.get_x() - l_start.get_x()))
		> 0)
		return (1);
	return (-1);
}
